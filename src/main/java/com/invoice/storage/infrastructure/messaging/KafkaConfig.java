...
/**
 * Kafka configuration for event-driven integration
 */
@Configuration
@EnableKafka
public class KafkaConfig {
     ...
     */
    @Bean
    public ConsumerFactory<String, PdfGeneratedEvent> consumerFactory() {
     ...
     */
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PdfGeneratedEvent> kafkaListenerContainerFactory() {
