 ...
 */
@Getter
public class CompensatePdfStorageCommand extends IntegrationEvent {
     ...
     */
    public CompensatePdfStorageCommand(String sagaId, String sagaStep, String correlationId,
