 ...
 * Consumed by invoice-pdf-generation-service and taxinvoice-pdf-generation-service.
 */
@Getter
public class XmlStoredEvent extends IntegrationEvent {
     ...
     */
    public XmlStoredEvent(String invoiceId, String storageUrl, String objectName,
