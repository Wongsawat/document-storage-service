 ...
 */
@Getter
public class CompensateSignedXmlStorageCommand extends IntegrationEvent {
     ...
     */
    public CompensateSignedXmlStorageCommand(String sagaId, String sagaStep, String correlationId,
