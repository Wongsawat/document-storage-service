 ...
 * Replies are sent to orchestrator via saga.reply.document-storage topic.
 */
@Component
...
public class SagaReplyPublisher {
    ...
    private static final String REPLY_TOPIC = "saga.reply.document-storage";
    ...
    public void publishSuccess(String sagaId, SagaStep sagaStep, String correlationId) {
        DocumentStorageReplyEvent reply = DocumentStorageReplyEvent.success(sagaId, sagaStep, correlationId);
    ...
    public void publishFailure(String sagaId, SagaStep sagaStep, String correlationId, String errorMessage) {
        DocumentStorageReplyEvent reply = DocumentStorageReplyEvent.failure(sagaId, sagaStep, correlationId, errorMessage);
    ...
    public void publishCompensated(String sagaId, SagaStep sagaStep, String correlationId) {
        DocumentStorageReplyEvent reply = DocumentStorageReplyEvent.compensated(sagaId, sagaStep, correlationId);
